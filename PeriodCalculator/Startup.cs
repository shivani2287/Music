...
namespace PeriodCalculator
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration, IWebHostEnvironment env)
        {
            ...
            Environment = env;
            //using (var db = new PeriodCalculatorContext())
            //{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddEntityFrameworkSqlServer().AddDbContext<MusicContext>();
            ...
            var connection = Configuration.GetConnectionString("MusicConnection");
